...
```{r}
retail_plot_raw <- ggplotly(ggplot(data = retail_ts, aes(x = month, y = sales_millions)) +
  geom_line() +
  labs(
    x = "Month",
    y = "Sales (in millions)",
    title = "Sales (in millions) - Full-Service Restaurants",
...
```{r}
retail_plot_log <- ggplotly(ggplot(data = retail_ts, aes(x = month, y = log(sales_millions))) +
  geom_line() +
  labs(
    x = "Month",
    y = "Log of Sales (in millions)",
    title = "Log of Sales (in millions) - Full-Service Restaurants",
    subtitle = "General Merchandise Stores"
  ) +
  theme_minimal() +
  theme(
