...
plain <- ggplotly(autoplot(chocolate_month_ts, .vars = m_hat) +
  labs(
    x = "Month",
    y = "Searches",
...
fancy <- ggplotly(autoplot(chocolate_month_ts, .vars = value) +
  labs(
    x = "Month",
    y = "Searches",
...
```{r}
ggplotly(ggplot(chocolate_month_ts, aes(x = factor(month), y = value)) +
    geom_boxplot() +
  labs(
    x = "Month Number",
    y = "Searches",
