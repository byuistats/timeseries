...
-   The mean can change, but we have no idea about the direction.
...
<a href="handouts/chapter_3_2_handout.xlsx" download="chapter_3_2_handout.xlsx"> Tables-Handout-Excel </a>
...
speed_plot / rand_plot # uses patchwork
```
...
ny_speeds_model1 <- ny_speeds_ts |>
  model(Additive = ETS(speed ~
                         trend("N", alpha = 0.1429622, beta = 0) +
                         error("A") +
                         season("N"),
                       opt_crit = "amse", nmse = 1))
augment(ny_speeds_model1) |>
...
<a href="handouts/chapter_3_2_handout_key.xlsx" download="chapter_3_2_handout_key.xlsx"> Tables-Handout-Excel-key </a>
