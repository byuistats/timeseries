...
min_ss1pe <- sum(components(ny_speeds_model0)$remainder^2, na.rm = TRUE) |> round(4)
...
-   Choose values of $\alpha$ slightly less than and slightly greater than `r alpha_est`. Can you find a value of $\alpha$ that gives you a smaller *SS1PE* than `r min_ss1pe`?
