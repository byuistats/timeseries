...
style="font-size:.6em;">(Meme)</a>

::: {#Meme style="display:none;"}

![Loki S2 is great](../images/MobiusMeme.png)

:::

::: callout-caution
Insert Stationary Realization App
:::
...
```{r}
cov_df1 <- get_data_for_cov_table(offset = 1)
cov_df1 %>%
  make_cov_table_df(offset = 1) %>%
  display_cov_table()
```
