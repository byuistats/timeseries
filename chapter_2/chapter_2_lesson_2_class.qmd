...
make_cov_table_df <- function(df, offset = 1, decimals_1st_order = 1, decimals_2nd_order = 2) {
  # Color vector
...
cov_df2 %>%
  make_cov_table_df(offset = 1, decimals_1st_order = 3, decimals_2nd_order = 3) %>% 
  knitr::kable(format = "html", align='cccccccc', escape = FALSE, width = NA) %>%
  kable_styling(full_width = FALSE, "striped") 
```
...
cov_df4 %>%
  make_cov_table_df(decimals_1st_order = 3, decimals_2nd_order = 3) %>% 
  knitr::kable(format = "html", align='cccccccc', escape = FALSE, width = NA) %>%
  kable_styling(full_width = FALSE, "striped") 
```
