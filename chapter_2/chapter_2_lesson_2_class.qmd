...
# Chapter 2 Lesson 2: Autocorrelation Concepts
...
ggplot(df, aes(x = time)) +
  ...
  labs(title="Comparison of Independent and Autocorrelated Data", 
       x="Time",
       y="Values",
       color="Series") +
  theme_bw()
...
We will use the following data to explore these concepts.
...
-   Complete the table above to compute the values of $c_2$ and $r_2$.
...
-   Compute $c_5$ and $r_5$ using R, Excel, or hand calculations.
