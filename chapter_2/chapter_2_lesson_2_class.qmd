...
<details>
  <summary>Define covariance, autocovariance, autocorrelation</summary>
...
<details>
  <summary>Explain autocorrelation in time series</summary>
...
-   Working with your assigned partner, compute each of the values in row 1. Verify that each of the numbers in the table was computed correctly. Recall that $\bar x = `r mean(cov_df$x)`$.
...
=======
First, we compute $c_0$: $$ 
>>>>>>> df5382e54b4cbc65b52186590bcc5a035dc5b08d
  c_0 
...
The figure below illustrates the correlations between $x_t$ and $X_{t+2}$.
...
-   Does the value of $r_3 = $ you computed seem reasonable, given the pattern in this plot?
...
z <- acf(cov_df$x, plot=FALSE, type = "correlation") 
...
-   There are two big spikes in the observed data. Can you identify a cause for these spikes?
=======
-   Is there evidence of autocorrelations in the data after removing the trend and seasonal variation?

-   There are two unusually large spikes in the observed data. Can you identify a cause for these spikes?
>>>>>>> df5382e54b4cbc65b52186590bcc5a035dc5b08d
