...
make_cov_table_df <- function(offset = 1, decimals_1st_order = 1, decimals_2nd_order = 2) {
  # Color vector
...
make_cov_table_row_blank <- function(df, row_num) {
  for (col_num in 4:ncol(df)) {
    df[row_num, col_num] = ""
  }
  return(df)
}
...
```{r}
make_cov_table_df(offset = 1, decimals_1st_order = 1, decimals_2nd_order = 2) %>%
  make_cov_table_row_blank(8) %>% 
  make_cov_table_row_blank(9) %>% 
  make_cov_table_row_blank(10) %>%
  make_cov_table_row_blank(11) %>%
  knitr::kable(format = "html", align='cccccccc', escape = FALSE, width = NA) %>% 
  kable_styling(full_width = FALSE, "striped") 
```

```{r}
make_cov_table_df(offset = 2, decimals_1st_order = 3, decimals_2nd_order = 3) %>% 
  knitr::kable(format = "html", align='cccccccc', escape = FALSE, width = NA) %>%
  kable_styling(full_width = FALSE, "striped") 
```

```{r}
make_cov_table_df(offset = 3, decimals_1st_order = 3, decimals_2nd_order = 3) %>% 
  knitr::kable(format = "html", align='cccccccc', escape = FALSE, width = NA) %>%
  kable_styling(full_width = FALSE, "striped") 
```
