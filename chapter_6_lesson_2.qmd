...
\begin{align*}
  \log(x_t) &= \beta_0 
            + 0.688 \left( \frac{t - \mu_t}{\sigma_t} \right) 
          + s_t  + z_t
\end{align*}
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-auto
#| fig-cap: "ACF plot of the residuals from the model chosen by the algorithm"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-auto
#| fig-cap: "PACF plot of the residuals from the model chosen by the algorithm"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a000
#| fig-cap: "ACF plot of the residuals from the $ARMA(0,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a000
#| fig-cap: "PACF plot of the residuals from the $ARMA(0,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a001
#| fig-cap: "ACF plot of the residuals from the $ARMA(0,1)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a001
#| fig-cap: "PACF plot of the residuals from the $ARMA(0,1)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a002
#| fig-cap: "ACF plot of the residuals from the $ARMA(0,2)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a002
#| fig-cap: "PACF plot of the residuals from the $ARMA(0,2)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a100
#| fig-cap: "ACF plot of the residuals from the $ARMA(1,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a100
#| fig-cap: "PACF plot of the residuals from the $ARMA(1,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a101
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a102
#| fig-cap: "ACF plot of the residuals from the $ARMA(1,2)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a102
#| fig-cap: "PACF plot of the residuals from the $ARMA(1,2)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a200
#| fig-cap: "ACF plot of the residuals from the $ARMA(2,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a200
#| fig-cap: "PACF plot of the residuals from the $ARMA(2,0)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a201
#| fig-cap: "ACF plot of the residuals from the $ARMA(2,1)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a201
#| fig-cap: "PACF plot of the residuals from the $ARMA(2,1)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-ACFofResiduals-a202
#| fig-cap: "ACF plot of the residuals from the $ARMA(2,2)$ model"
...
#| code-summary: "Show the code"
#| warning: false
#| label: fig-PACFofResiduals-a202
#| fig-cap: "PACF plot of the residuals from the $ARMA(2,2)$ model"
...
PerformanceAnalytics::skewness(retail_resid_df$x)
```
