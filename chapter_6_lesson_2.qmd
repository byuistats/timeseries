...
Here are some steps you can use to guide your work in a time series analysis. Even though these are presented linearly, you may find it helpful to iterate between some of the steps as needed.

::: {.callout-warning icon=false title="Steps in a Time Series Analysis"}

-   Create a time plot of the time series
-   Determine an appropriate model for the trend and seasonality; call this Model 1
    -   Regression
    -   Holt-Winters
    -   Additive / Multiplicative Decomposition
    -   Other Techniques
-   Use AIC/AICc/BIC or other metrics to choose the best model
