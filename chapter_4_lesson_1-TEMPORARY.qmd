...
Consider the closing price of McDonald's stock. 
...
time_plot <- plot_ly(desired_tsibble, x = ~dates, y = ~value, type = 'scatter', mode = 'lines') %>%
  layout(
...
diff_plot <- plot_ly(desired_tsibble, x = ~dates, y = ~diff, type = 'scatter', mode = 'lines') %>%
  layout(
    xaxis = list(title = "Date"),
    yaxis = list(title = "Value"),
