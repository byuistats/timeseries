...
## WRONG Vocabulary and Nomenclature Matching Activity (10 min)
...
|                                                                                                         |                                       |
|---------------------------------------------------------------------------------------------------------|---------------------------------------|
| 1\. Discrete observations of a time series, taken at times $1, 2, \ldots, n$.                           | A. $n$  |



| 2\. Number of observations of a time series                                                             | B. $k$                              |
| 3\. Lead time                                                                                          | C. $m_t$                           |
| 4\. The trend as observed at time $t$                                                                  | D. $\hat m_t$                       |
| 5\. The seasonal effect, as observed at time $t$                                                       | E. $s_t$                              |
| 6\. The error term (a sequence of correlated random variables with mean zero), as observed at time $t$ | F. $\hat s_t = x_t - \hat m_t$                              |
| 7\. Centered moving average for obsrvations made monthly                                               | G. $\hat s_t = \dfrac{x_t}{\hat m_t}$                         |
| 8\. Estimate of monthly additive effect                                                                | H. $\{x_t\}$        |
| 9\. Estimate of monthly multiplicative effect                                                          | I. $z_t$  |
| 10\. Forecast made at time $t$ for a future value $k$ time units in the future | J. $\bar s_t$         |
| 11\. Additive decomposition model                                              | K. $x_t = m_t + s_t + z_t$       |
| 12\. Additive decomposition model after taking the logarithm                   | L. $x_t = m_t \cdot s_t + z_t$   |
| 13\. Multiplicative decomposition model                                        | M. $\log(x_t) = m_t + s_t + z_t$ |
| 14\. Seasonally adjusted mean for the month corresponding to time $t$          | N. $x_t - \bar s_t$              |
| 15\. Seasonal adjusted series (additive seasonal effect)                       | O. $\frac{x_t}{\bar s_t}$        |
| 16\. Seasonal adjusted series (multiplicative seasonal effect)                 | P. $\hat x_{t+k \mid t}$         |
...
<!-- D. $\hat m_t$ -->
<!-- E. $s_t$ -->
<!-- F. $\hat s_t = x_t - \hat m_t$ -->
<!-- G. $\hat s_t = \dfrac{x_t}{\hat m_t}$ -->
<!-- H. $\{x_t\}$ -->
...
10. Forecast made at time $t$ for a future value $k$ time units in the future
11. Additive decomposition model
12. Additive decomposition model after taking the logarithm
13. Multiplicative decomposition model
14. Seasonally adjusted mean for the month corresponding to time $t$
15. Seasonal adjusted series (additive seasonal effect)
16. Seasonal adjusted series (multiplicative seasonal effect)
...
J. $\bar s_t$
K. $x_t = m_t + s_t + z_t$
L. $x_t = m_t \cdot s_t + z_t$
M. $\log(x_t) = m_t + s_t + z_t$
N. $x_t - \bar s_t$
O. $\frac{x_t}{\bar s_t}$
P. $\hat x_{t+k \mid t}$
...
|                                                                                                         |                                       |
|---------------------------------------------------------------------------------------------------------|---------------------------------------|
| 1\. Discrete observations of a time series, taken at times $1, 2, \ldots, n$.                           | H. $\{x_t\}$                          |
| 2\. Number of observations of a time series                                                             | A. $n$                                |
| 3\. Lead time                                                                                          | B. $k$                                |
| 4\. The trend as observed at time $t$                                                                  | C. $m_t$                              |
| 5\. The seasonal effect, as observed at time $t$                                                       | E. $s_t$                              |
| 6\. The error term (a sequence of correlated random variables with mean zero), as observed at time $t$ | I. $z_t$                              |
| 7\. Centered moving average for obsrvations made monthly                                               | D. $\hat m_t$                         |
| 8\. Estimate of monthly additive effect                                                                | F. $\hat s_t = x_t - \hat m_t$        |
| 9\. Estimate of monthly multiplicative effect                                                          | G. $\hat s_t = \dfrac{x_t}{\hat m_t}$ |
| 10\. Forecast made at time $t$ for a future value $k$ time units in the future | P. $\hat x_{t+k \mid t}$         |
| 11\. Additive decomposition model                                              | K. $x_t = m_t + s_t + z_t$       |
| 12\. Additive decomposition model after taking the logarithm                   | M. $\log(x_t) = m_t + s_t + z_t$ |
| 13\. Multiplicative decomposition model                                        | L. $x_t = m_t \cdot s_t + z_t$   |
| 14\. Seasonally adjusted mean for the month corresponding to time $t$          | J. $\bar s_t$                    |
| 15\. Seasonal adjusted series (additive seasonal effect)                       | N. $x_t - \bar s_t$              |
| 16\. Seasonal adjusted series (multiplicative seasonal effect)                 | O. $\frac{x_t}{\bar s_t}$        |
:::
