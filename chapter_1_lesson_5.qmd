...
x_plot / trend_plot / seasonal_plot / error_plot # uses patchwork
```
...
rexburg_weather_plot / sp500_plot # uses patchwork
```
...
apple_ts <- rio::import("https://byuistats.github.io/timeseries/data/apple_revenue_2026.xlsx") |>
  mutate(
    dates = mdy(date),
...
<a href="handouts/chapter_1_5_handout.xlsx" download="chapter_1_5_handout.xlsx"> Tables-Handout-Excel </a>
...
<a href="handouts/chapter_1_5_handout_key.xlsx" download="chapter_1_5_handout_key.xlsx"> Tables-Handout-Excel-key </a>
