...
nat_gas_ts |>
  ...
  mutate(
    x_t = ifelse(t %in% c(-3:0, 28:nrow(nat_gas_ts)), emdash, x_t),
    a_t = ifelse(t %in% c(-3:0, 28:nrow(nat_gas_ts)), emdash, a_t),
    b_t = ifelse(t %in% c(-3:0, 28:nrow(nat_gas_ts)), emdash, b_t),
...
<!--   for(col_num in 2:5) { -->
<!--     choc_hw_ts3[row_num, col_num] <- emdash -->
<!--   } -->
<!-- } -->
