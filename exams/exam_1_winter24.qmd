...
![Series #1](../images/test1_winter24_fig2.png)
...
![Series #1](../images/test1_winter24_fig1.png)
...
### Question 3 - In Chapter 1, Lesson 4, we computed the additive decomposition for the traffic deaths data. Here is the plot of the decomposition. Is the additive model appropriate for these data. Why or why not?
...
```{r}
temp1 <- rio::import("../data/test1_winter24_data1.csv")
```
