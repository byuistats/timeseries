...
## Vocabulary and Momenclature Matching Activity (15 mins)
...
pbox <- ggplot(chocolate_month_ts, aes(x = factor(month), y = value)) +
  ...
  labs(
    x = "Month Number",
    y = "Searches",
    title = "Boxplot of Google Searches for 'Chocolate' by Month"
  ) +
  theme(plot.title = element_text(hjust = 0.5))
...
-   For each of the following, does the "amplitude" of the "wiggles" gets bigger as time goes by?
    -   Daily high temperature in Rexburg
    -   Daily closing prices of the S&P 500
-   For each scenario, which is more appropriate, an additive model or a multiplicative model? Justify your answer.
    -   Daily high temperature in Rexburg
    -   Daily closing prices of the S&P 500
