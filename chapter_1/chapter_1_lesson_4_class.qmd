...
This is a demonstration of how to read in an Excel 
or csv data file and convert it to a tsibble.
...
To emphasize the computation of the centered moving average, the observed data values that were used to find $\hat m_t$ for December 2017 are shown in <span style="color:#0072B2;">blue</span>. 
...
deaths_shat_ts |>
  ...
  color_specific_cell(row_num = 12, col_num = 4, color = "#0072B2") |>
  color_specific_cell(row_num = 6, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 7, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 8, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 9, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 10, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 11, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 12, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 13, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 14, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 15, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 16, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 17, col_num = 3, color = "#0072B2") |>
  color_specific_cell(row_num = 18, col_num = 3, color = "#0072B2") |>
  display_table()
```
...
adj_s_bar_df <- deaths_ts2 |>
  ...
  dplyr::select(month, adjusted_s_bar)
...
The mean of the the $\bar s_t$ values is `r mean(adjusted_ts$s_hat) %>% round(3)`.
We will subtract this from each of the $\hat s_t$ values to get the adjusted monthly additive effect.
...
Solutions for the computations of the Monthly Additive Effect
