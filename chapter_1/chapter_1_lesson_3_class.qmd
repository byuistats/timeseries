...
<details>
<summary>Explain the purpose and limitations of forecasting ----- NOT ACTUALLY ADDRESSED</summary>
    -   Define forecasting
...
-   Using any tool (except R functions that automate the process) compute the centered moving average for the chocolate data. To help your check yourself, the value of $\hat m$ in month 7 should be `r chocolate_month_ts %>% data.frame() %>% filter(row_number() == 7) %>% dplyr::select(m_hat) %>% pull()`.
