...
The cleaned version of the data used for this demonstration are available in the file <a href="data/chocolate.csv" download>chocolate.csv</a>. We can read this directly into a data frame using the command `chocolate_month <- `rio::import("https://byuistats.github.io/timeseries/data/chocolate.csv")`.
