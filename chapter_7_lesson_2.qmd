...
## Class Activity: Seasonal ARIMA Models (xxx min)


### Definition of Seasonal ARIMA Models

::: {.callout-note icon=false title="Definition of Seasonal ARIMA Models"}
...
## Class Activity: Fitting a Seasonal ARIMA Process (xxx min)
