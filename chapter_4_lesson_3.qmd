---
title: "Autoregressive Models: Part 1 (MAYBE RECOMBINE)"
...
-   Justify why it is reasonable to call this an autoregressive model.
...
4.    Choose one stationary process and one non-stationary process. Simulate at least 1000 successive observations from each. What do you observe about the difference in the behavior of these processes?
