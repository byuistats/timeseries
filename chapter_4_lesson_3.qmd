...
Let $z = a+bi$ be any complex number. It is represented by the point $~<a,b>~$ in the complex plane.  We define the absolute value of $x$ as the distance from the origin to the point:
...
If the solutions of the characteristic equation are all greater than 1 in absolute value
