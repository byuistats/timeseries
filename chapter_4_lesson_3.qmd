...
## Small-Group Activity: Exploring $AR(0)$ Models (5 min)

We can utilize an $AR(p)$ model for any integer value of $p \ge 0$.

<!-- Check Your Understanding -->

::: {.callout-tip icon=false title="Check Your Understanding"}

-   Give the form of an $AR(0)$ model.
-   What is another name for an $AR(0)$ model?
...
-   Give the form of an $AR(1)$ model.
-   What is another name for an $AR(1)$ model?
...
<a href="javascript:showhide('SolutionsAR0')"
style="font-size:.8em;">$AR(0)$</a>

::: {#SolutionsAR0 style="display:none;"}

Solutions to Small-Group Activity
...
$$
  x_t = \alpha_1 x_{t-1} + \alpha_2 x_{t-2} + \alpha_3 x_{t-3} + \cdots + \alpha_{p-1} x_{t-(p-1)} + \alpha_p x_{t-p} + w_t
$$
So, an $AR(0)$ model is expressed as
$$
  x_t = w_t
$$
where $\{w_t\}$ is a white noise series with mean zero and variance $\sigma^2$.
...
<a href="javascript:showhide('SolutionsAR1')"
style="font-size:.8em;">$AR(1)$</a>

::: {#SolutionsAR1 style="display:none;"}
