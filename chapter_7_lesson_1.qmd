...
pacman::p_load(
  nanoparquet, # loads parquet files faster
  tidyquant    # tq_get
)
```
...
# Fetch stock prices
df_stock <- tidyquant::tq_get(symbol, from = date_start, to = date_end, get = "stock.prices")
...
plotly::plot_ly(stock_ts, x = ~dates, y = ~value, type = 'scatter', mode = 'lines') |>
  layout(
