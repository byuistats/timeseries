...
In some cases, a lagged difference is more appropriate. For example, if you have monthly data and need to remove additive seasonal effects, you may want to take a difference with a lag of 12. This subtracts sequential January observations from each other. This yields the year-over-year growth. Notice that taking a lag 12 difference 
$$  
...
\begin{align*}
  \nabla^{12} x_t 
    ...
    &= x_t - 12 x_{t-1} + 66 x_{t-2} - 220 x_{t-3} + 495 x_{t-2} - 792 x_{t-3} + 924 x_{t-2} \\
    & ~~~~~~~~~~~~~~~~ - 792 x_{t-3} + 495 x_{t-2} - 220 x_{t-3} + 66 x_{t-2} - 12 x_{t-11} + x_{t-12}
\end{align*}
