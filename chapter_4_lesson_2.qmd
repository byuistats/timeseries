...
Note: the plotly package causes conflicts with tidyverse. Click below if you have code issues.
...
# The plotly package creates conflicts with functions from the tidyverse package
# This makes sure it defaults to the tidyverse version
# Alternatively, using dplyr::select(), or loading plotly before pacman resolves the issue
...
<a href="handouts/chapter_4_2_handout.xlsx" download="chapter_4_2_handout.xlsx"> Tables-Handout-Excel </a>
...
<a href="handouts/chapter_4_2_handout_key.xlsx" download="chapter_4_2_handout_key.xlsx"> Tables-Handout-Excel-key </a>
