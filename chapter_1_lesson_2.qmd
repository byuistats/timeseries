...
```{=html}
 <iframe id="stochastic" src="https://posit.byui.edu/content/728a7ddc-97d2-44ee-9977-fc648102b986" style="border: none; width: 100%; height: 520px" frameborder="0"></iframe>
```
...
```{=html}
 <iframe id="deterministic" src="https://posit.byui.edu/content/4d25268b-d562-455c-ac47-5a9871770e7c" style="border: none; width: 100%; height: 520px" frameborder="0"></iframe>
```
...
Recall the Google Trends data for the term "chocolate" from the last lesson. The cleaned data are available in the file <a href="data/chocolate.csv" download>chocolate.csv</a>.
