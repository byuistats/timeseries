...
The values S1, S2, S3, $\ldots$ represent the coefficients on sine functions with $i=1$, $i=2$, $i=3$, $\ldots$. Similarly, the values C1, C2, C3, $\ldots$ represent the coefficients on the corresponding cosine terms.
