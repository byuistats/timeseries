...
\begin{align*}
  s_t 
    ...
    &=~~~ \left\{ A_1 \sin \left( \frac{2\pi t}{12} \right) + B_1 \cos \left( \frac{2\pi t}{12} \right) \right\} & \leftarrow i = 1 \\
    ...
    &=~~~ \left\{ A_1 \sin \left( \frac{2\pi t}{12} \right) + B_1 \cos \left( \frac{2\pi t}{12} \right) \right\}  \\
...
Note that $\sin \left( \frac{2\pi \cdot 6 t}{12} \right) = 0$ for all integer values of $t$, so we can omit this term.
