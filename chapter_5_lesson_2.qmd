...
However, for a discrete time series with $s$ seasons, we are only need to evaluate the function at a finite number of points: 
$t = 1, 2, 3, \ldots, s-1, s$. 
...
# THE FLOW IS NOT GOOD HERE...NEED TO GIVE THE RESULT, and POSSIBLY COMPARE WITH THE RESULT BELOW.
# THE FLOW IS NOT GOOD HERE...NEED TO GIVE THE RESULT, and POSSIBLY COMPARE WITH THE RESULT BELOW. 
...
$$
  zTIME = \frac{t - mean~of~t}{standard~deviation~of~t} = \frac{t - \bar t}{s_t}
$$
