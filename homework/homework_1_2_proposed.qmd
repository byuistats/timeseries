...
[Chapter 1 Outcome Map](https://docs.google.com/spreadsheets/d/1iYftJo380M2d9rV-KexgEaCjkKbqK3Ip7uEdn-Y15B4/edit?usp=sharing)
...
#### [a) US unemployment](https://www.bls.gov/cps/cps_htgm.htm)
...
#### [b) The Term Premium](https://www.newyorkfed.org/research/data_indicators/term-premia-tabs#/overview)
[https://www.newyorkfed.org/research/data_indicators/term-premia-tabs#/overview](https://www.newyorkfed.org/research/data_indicators/term-premia-tabs#/overview)

::: {.callout-note title="Answer" icon="false"}
<!-- Delete this and put your answer here. The three colons mark the end of your answer. -->
:::

#### [c) Chocolate Trends](https://support.google.com/trends/answer/4365533?hl=en)
[https://support.google.com/trends/answer/4365533?hl=en](https://support.google.com/trends/answer/4365533?hl=en)
...
Define the terms "sampling interval," "time series trend," "seasonal variation," "cycle," "deterministic trend," and "stochastic trend" in your own words.
...
Please *compare and contrast* the trends and seasonal features of the US unemployment, term premium, and the chocolate Google search series. 
Use appropriate technical language to describe the main features of each time series (sampling interval, time series trend, seasonal variation, cycle, deterministic and stochastic trends.) Use R to condut your analysis and include the relevant illustrations in your output.
