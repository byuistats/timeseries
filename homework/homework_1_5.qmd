...
vessels <- rio::import("C:/Users/moncayod/Downloads/R Renders/Vessels_Trade_US.csv")
...
::: {.callout-note title="Answer" icon="false"}
-   **Multiplicative Decomposition**: <!-- Delete this and put your answer here. -->

-   **Estimators of seasonal variation for a multiplicative model**: <!-- Delete this and put your answer here. -->
:::
...
1.  Justify why we use the multiplicative decomposition model instead of the additive model to seasonally adjust the series.
