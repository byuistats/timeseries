...
Each observation is the total number of deaths that year, the population and the mortality rate per 100,000 people.
:::
...
ggplot() +
  ...
  geom_line(data = fitted_values, aes(x = year, y = .fitted, color = "Fitted (Minimized SS1PE)"), size = 1, linetype = "dashed") +
  labs(
    title = "U.S. Mortality Rate per 100,000 Population (1968-2021)",
    x = "Year",
    y = "Mortality Rate per 100,000",
...
ggplot() +
  geom_line(data = mortality, aes(x = year, y = `mort_rate_per_100,000`, color = "Original Data"), size = 1.5) +
  geom_line(data = fitted_values_alpha_0.2, aes(x = year, y = .fitted, color = "Fitted (Alpha = 0.2)"), size = 1, linetype = "dotted") +
  labs(
    title = "U.S. Mortality Rate per 100,000 Population (1968-2021)",
    x = "Year",
    y = "Mortality Rate per 100,000",
...
ggplot() +
  ...
  geom_line(aes(x = fitted_values_alpha_1_n$year, y = fitted_values_alpha_1_n$.fitted, color = "Fitted with Alpha = 1/n"), size = 1, linetype = "dotted") +
