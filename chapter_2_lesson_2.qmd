...
```{r}
#| include: false
# Extra packages this lesson
pacman::p_load(
  see,  # color_scale_okabeito()
  MASS  # mvrnorm()
)
```
...
Note: the MASS package causes conflicts with tidyverse. Click below if you have code issues.
...
# The MASS package creates conflicts with the select() function from the tidyverse package
# This makes sure it defaults to the tidyverse version
# Alternatively, loading MASS first, or using dplyr::select() resolves the issue
pacman::p_load(conflicted)
conflict_prefer("select", "dplyr")
```

<!-- Functions used throughout this lesson -->
...
<a href="handouts/chapter_2_2_handout.xlsx" download="chapter_2_2_handout.xlsx"> Tables-Handout-Excel </a>
...
<a href="handouts/chapter_2_2_handout_key.xlsx" download="chapter_2_2_handout_key.xlsx"> Tables-Handout-Excel-key </a>
