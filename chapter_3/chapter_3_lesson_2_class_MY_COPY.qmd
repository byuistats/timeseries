...
ny_speeds_tb <- ny_speeds_dat |>
  mutate(
    ...
    min = lubridate::minute(dates)
  ) %>%
  rename(speed = Speed) |>
  dplyr::select(-Id, -TravelTime, -Status, -DataAsOf, -linkId) |>
  tibble()

<<<<<<< HEAD:chapter_3/chapter_3_lesson_2_class_MY_COPY.qmd
rio::export(ny_speeds_tb, "temp.csv")
...
#   mutate(index = dates) |>
#   as_tsibble(index = index)
>>>>>>> 85f0c8c856664d5719118cb490e1ff32eee31c20:chapter_3/chapter_3_lesson_2_class.qmd
```
