...
::: callout-caution 
Tyson, I need help getting the following code to run. Based on what I saw online, I think it might be failing, due to a conflict in the order in which packages are loaded.
:::
...
## Small Group Activity: Computing the Sample CCF (15 min)
...
x_str <- paste(sim_df$x, collapse = ", ")
y_str <- paste(sim_df$y, collapse = ", ")
x_str2 <- paste0("x = c(",x_str,")")
y_str2 <- paste0("y = c(",y_str,")")
xy_str <- paste0("df <- data.frame(",x_str2,", ",y_str2,")")
```
