...
xy_string[4] <- ")"
xy_str <- paste(xy_string, "\n", collapse="")
```
::: callout-caution 
Tyson, will you please see if you can make this print so that it looks like this: (on four lines, with the middle two lines indented?)
```{r}
df <- data.frame(
