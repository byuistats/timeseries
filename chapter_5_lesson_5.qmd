...
In [Lesson 4 of this chapter](https://byuistats.github.io/timeseries/chapter_5_lesson_4.html#Simulation), we simulated a time series with an exponential trend. In this lesson, we will forecast future values based on that model.
...
Insert code for Small-Group Activity here
...
forecast_plot1 <- model_combined |> 
  select(reduced_linear1) |>
