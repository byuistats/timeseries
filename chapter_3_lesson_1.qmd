...
## Class Discussion: Definition of the Sample CCVF and Sample CCF (5)
...
The U. S. Census Bureau publishes monthly counts of the number of building permits issued for new housing construction, the number of housing units started, and the number of housing units completed. We will examine data for single-family dwellings.
...
housing <- rio::import("data/housing.csv") |>
  ...
  filter(date >= my("Jan 1995")) |>
  filter(date < my("Jan 2020")) |>
