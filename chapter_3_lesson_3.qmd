...
#### Holt-Winters Filtering (Winter's Exponential Smoothing)

Peter Winters was a colleague of Holt's at the Carnagie Institute of Technology. In 1960, he published an enhancement of Winters' technique that allowed for seasonal variation. This is known as the **Holt-Winters Method** or **Holt-Winters Filtering**. The forecasting equation is:
