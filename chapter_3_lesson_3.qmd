...
We will implement these in the model as 
$$
...
nat_gas_ts <- nat_gas |>
  hw_additive_slope_additive_seasonal_gas("quarter", "gas_billion_cf", p = 4, predict_periods = 12, s_initial = c(1000, -1000, -1000, 1000)) |>
  as_tsibble(index = date) |> 
