...
byui_enrollment_ts |> 
  autoplot(.vars = enrollment_1000) +
    labs(
      x = "Time",
      y = "Enrollment (in Thousands)",
      title = "BYU-Idaho On-Campus Enrollment"
    ) +
    theme(
...
byui_enrollment_ts |> 
  as_tibble() |>
  hw_additive_slope_multiplicative_seasonal("dates", "enrollment_1000", p = 3, predict_periods = 12) |>
